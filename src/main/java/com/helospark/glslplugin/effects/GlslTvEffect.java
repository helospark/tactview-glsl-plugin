...
public class GlslTvEffect extends AbstractRegularGlslStatelessVideoEffect {
    ...
    public GlslTvEffect(JsonNode node, LoadMetadata loadMetadata, GlslUtil glslUtil, RenderBufferProvider renderBufferProvider, VertexBufferProvider vertexBufferProvider,
            ShadertoyHelpers shadertoyHelpers) {
        super(node, loadMetadata, glslUtil, renderBufferProvider, vertexBufferProvider);
        this.shadertoyHelpers = shadertoyHelpers;
    }

    public GlslTvEffect(GlslTvEffect effect, CloneRequestMetadata cloneRequestMetadata) {
