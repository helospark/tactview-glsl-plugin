uniform float rainSpeed; // 1.75 // Speed of rain droplets
uniform float dropSize; //  3.0  // Higher value lowers, the size of individual droplets
...
void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
    ...
    float globalTime = iTime * rainSpeed;
